...
public class PIDDriveInchesSandstorm extends Command {
...
//    private final static int I_ZONE_IN_REVOLUTIONS = 50; //100;
    ...
    public PIDDriveInchesSandstorm(double inches, boolean reverse) {
...
//        Robot.DRIVE_SUBSYSTEM.talonDriveRightPrimary.config_IntegralZone(slotIdx, I_ZONE_IN_REVOLUTIONS, timeoutMs);
        ...
        if (driveInches > 30) {
            Robot.DRIVE_SUBSYSTEM.leftDrivePrimary.configMotionCruiseVelocity(1000, timeoutMs); //7500, 20500, 7500, 20000
            Robot.DRIVE_SUBSYSTEM.leftDrivePrimary.configMotionAcceleration(20000, timeoutMs); //test 5000
            Robot.DRIVE_SUBSYSTEM.rightDrivePrimary.configMotionCruiseVelocity(1000, timeoutMs);
